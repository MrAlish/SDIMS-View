...
const CreateBusinessOwnershipTypeId = () => {
  ...
  let filteredData = apiData.find(
    (item) => item.id === parseInt(query.businessownerid)
  );

  return (
    <ViewPage>
      <SeoOptimization title={"Create Business Ownership Type"} />
...
export default CreateBusinessOwnershipTypeId;
