...
const Group = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/common/group/creategroup/${id}`);
  };
  ...
  return (
    <div className="bg-gray-200 rounded-2xl shadow-2xl pb-4 pt-2 px-5 flex flex-col gap-1 ">
      ...
      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/common/group/creategroup");
          }}
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell>sewaId</StyledTableCell>
              ...
              {apiData.map((row, index) => {
                return (
                  <StyledTableRow key={index}>
                    ...
                    <StyledTableCell>{row.sewaId}</StyledTableCell>
