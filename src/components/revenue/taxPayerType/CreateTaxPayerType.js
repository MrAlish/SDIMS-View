...
const CreateTaxPayerType = ({ clickedIdData }) => {
  const {
    register,
    handleSubmit,
  ...
  const onSubmit = (data) => {
    return new Promise((resolve) => {
      setTimeout(() => {
        try {
          createTaxPayerType(data).then((response) => {
  ...
  return (
    <>
      <CommonHeaderDesign title={"Create Tax Payer Type"} />
...
export default CreateTaxPayerType;
